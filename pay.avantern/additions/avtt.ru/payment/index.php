...
$APPLICATION->SetPageProperty("HEADER-PICTURE", "/bitrix/templates/avtt.ru/images/header/pay.jpg");
$APPLICATION->SetPageProperty("title", "Оплата пластиковой картой — АВАНТЕРН Телематика");
$APPLICATION->SetTitle("Оплата пластиковой картой");
?><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pay-form">
	<div class="row">
		<form id="pay-form" class="pay-form" action="/bitrix/templates/avtt.ru/ajax/payment.php" method="post">
										...
										<div class="input">
											<div class="select">
												<select name="firm" id="firm" required="">
													<option selected="selected" value="1">ЭФ БИ АЙ</option>
												</select>
											</div>
										</div>
									</div>
 ...
 <input class="name" type="text" name="dogovor" id="dogovor" placeholder="Номер договора" required="">
										...
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<div class="row">
												<div class="input">
 <input class="name" type="text" name="email" id="email" placeholder="Введите вашу почту" required="">
												</div>
											</div>
										</div>
									</div>
 ...
 <input class="name right price" type="text" name="kop" id="kop" placeholder="Копеек" required="">
								...
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
									<div class="row">
										<div class="input last">
											<div class="load">
 <img src="/bitrix/templates/avtt.ru/images/load.gif" class="img-responsive">
											</div>
											<div id="recaptcha" class="g-recaptcha" data-sitekey="6Lev6mcjAAAAABIMpKKD1ScVqbcdkqKhXQWRIkNl" data-callback="onSubmit" data-size="invisible">
											</div>
