...
$APPLICATION->SetTitle("Оплата через Сбер");
?><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pay-form">
	<div class="row">
		<form id="sberpay-form" class="newpay-form" action="/bitrix/templates/avantern/ajax/sberpayment.php" method="post">
 ...
 <input type="submit" class="active button-orange g-recaptcha" name="sberform-submit" id="sberform-submit" value="Перейти к оплате">
										</div>
									</div>
								</div>
							</div>
